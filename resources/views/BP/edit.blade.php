...
<div style="padding: 24px; max-width: 100%; box-sizing: border-box;">
    <div class="page-header">
        <div>
            <h1 class="page-title">Edit Data Piutang</h1>
            <p class="page-subtitle">Perbarui detail piutang konsumen.</p>
        </div>
    </div>

    <form method="POST" action="{{ url('/bp/' . ($id ?? ($record->id ?? ''))) }}">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px; width: 100%;">
            <div class="form-group">
                ...
                <input type="text" name="nama_konsumen" class="form-input" style="width: 100%;"
                    value="{{ old('nama_konsumen', $record->nama_konsumen ?? ($record['nama_konsumen'] ?? '')) }}">
            </div>
            <div class="form-group">
                <label class="form-label">Tgl. Bukti</label>
                <input type="date" name="tgl_bukti" class="form-input" style="width: 100%;"
            ...
            <div class="form-group">
                ...
                <input type="text" name="no_bukti" class="form-input" style="width: 100%;"
            ...
            <div class="form-group">
                ...
                <input type="text" name="debet" class="form-input" style="width: 100%;"
                    value="{{ old('debet', $record->debet ?? ($record['debet'] ?? '')) }}">
            </div>
            <div class="form-group">
                <label class="form-label">Kredit</label>
                <input type="text" name="kredit" class="form-input" style="width: 100%;"
                    value="{{ old('kredit', $record->kredit ?? ($record['kredit'] ?? '')) }}">
            </div>
            <div class="form-group">
                <label class="form-label">No Polisi</label>
                <input type="text" name="no_polisi" class="form-input" style="width: 100%;"
                    value="{{ old('no_polisi', $record->no_polisi ?? ($record['no_polisi'] ?? '')) }}">
            </div>
            <div class="form-group">
                <label class="form-label">No Polis</label>
                <input type="text" name="no_polis" class="form-input" style="width: 100%;"
            ...
            <div class="form-group full-width" style="grid-column: 1 / -1;">
                ...
                <input type="text" name="saldo_akhir" class="form-input" style="width: 100%;"
