...
@section('content')
    <div style="padding: 16px; max-width: 1100px; margin: 0 auto; box-sizing: border-box; background-color: #ffffff;">
        ...
        <form method="POST" action="{{ url('/gr/cinere/' . ($id ?? ($record->id ?? ''))) }}">
            @csrf
            @method('PUT')

            {{-- Section 1: Informasi Konsumen --}}
            <div class="form-section-card">
                <span class="section-title" style="color: #dc2626; border-bottom-color: #fca5a5;">1. Informasi
                    Konsumen</span>
            ...
            <div class="form-section-card" style="border-left: 3px solid #dc2626;">
                <span class="section-title" style="color: #dc2626; border-bottom-color: #fca5a5;">3. Rekonsiliasi & Saldo
                    Akhir</span>
                ...
                <div id="paymentStage2" class="payment-stage" data-stage="2"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan_2" class="form-input"
                ...
                <div id="paymentStage3" class="payment-stage" data-stage="3"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan_3" class="form-input"
                            value="{{ old('keterangan_3', $record->keterangan_3 ?? ($record['keterangan_3'] ?? '')) }}">
                    </div>
                </div>

                <div class="form-group"
                    style="border-top: 1px dashed #e5e7eb; padding-top: 10px; display: flex; align-items: center; gap: 12px;">
                    <label class="form-label"
                        style="margin-bottom: 0 !important; white-space: nowrap; font-size: 13px !important; color: #111827 !important;">Total
                        Saldo Akhir:</label>
            ...
            {{-- Footer Buttons --}}
            <div
                style="margin-top: 16px; display: flex; justify-content: flex-end; gap: 8px; border-top: 1px solid #e5e7eb; padding-top: 12px;">
