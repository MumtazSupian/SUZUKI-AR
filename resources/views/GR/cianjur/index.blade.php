                        ...
                        <tr>
                            ...
                            <td class="col-action">
                                <div style="display:flex; gap:6px;">
                                    <a href="{{ url('/gr/cianjur/' . ($row->id ?? ($row['id'] ?? '')) . '/edit') }}" class="action-btn edit" title="Edit" style="text-decoration: none;">✎</a>
                                    <form method="POST" action="{{ url('/gr/cianjur/' . ($row->id ?? ($row['id'] ?? ''))) }}" style="display:inline">@csrf @method('DELETE')<button class="action-btn delete" title="Hapus">🗑</button></form>
                                </div>
                            </td>
                        </tr>
                    @empty
